...
for root, dirs, files in os.walk(in_dir):
    for f in files:
        ...
        print >> sys.stderr, "checking", path
        ...
        print >> sys.stderr, "Orig Audio: ", filter_dict(audio, keyList)
        print >> sys.stderr, " New Audio: ", filter_dict(audio_lang, keyList)

        print >> sys.stderr, " Orig Subs: ", filter_dict(subtitle, keyList)
        print >> sys.stderr, "  New Subs: ", filter_dict(subtitle_lang, keyList)
        ...
        os.utime(path, (filestats.st_atime, filestats.st_mtime))
